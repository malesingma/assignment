...
This is a simple Solidity smart contract that creates a token called "AUGUST" with the abbreviation "AUG". It has a total supply that starts at 0, and uses a mapping of addresses to balances to keep track of how many tokens each address holds.
...
This program is a simple contract written in remix. The contract allows you to add and sub tokens to the account address.
...
4)The burn function deducts the given amount of tokens from the total supply and from the balance of the given address.
